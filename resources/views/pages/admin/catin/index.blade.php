...
@section('content')
    {{-- @include('pages.admin.payment.histori-pembayaran.modals') --}}
        ...
        <div class="py-4">
            <div class="d-flex flex-md-row flex-column gap-2 align-items-center w-100">
                <div class="search-box">
                    ...
                    <input type="text" data-table-id="catin-table" id="searchBox" data-action="search"
        ...
        <script>
            $(function() {
                function checkFilter() {
                    let table = window.LaravelDataTables['catin-table'];
                    let url = "{{ route('catin.catin.index') }}?";
                ...
                // ketika mencari data di kolom search
