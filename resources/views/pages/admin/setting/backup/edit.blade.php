...
@section('content')
    <div class="py-4">
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('setting.backup.update', ['backupSchedule' => $backupSchedule]) }}"
                    method="post" id="edit-backup_form">
                    @method('PUT')
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <x-atoms.select name="frequency" id="frequency_field" placeholder="Pilih Frekuensi" :value="$backupSchedule->frequency"
                            :lists="[
                                'daily' => 'Daily',
                                'weekly' => 'Weekly',
                                'monthly' => 'Monthly',
                    ...
                    <div class="d-flex justify-content-end g-2 mb-10">
                        <a href="{{ route('setting.backup.index') }}" class="btn btn-light me-3" cancel-btn>Back</a>
